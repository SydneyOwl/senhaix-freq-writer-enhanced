...
namespace SenhaixFreqWriter.Properties {
    ...
    public class Resources_zh {
        ...
        /// <summary>
        ///   Looks up a localized string similar to 您可能需要手动重启软件，改变的设置将在重启软件后生效！.
        /// </summary>
        ...
        ///    2、移除其他使用串口的设备；
        ///    3、点击下拉框，选择带“ttyUSB”的选项，例如：/dev/ttyUSB0即可；(注意：部分情况下可能不为ttyUSB*，请您自行判断)
        ///macOS:
        ///    1、确认您已安装好写频线的驱动（ch340可不用安装）；
        ///    2、移除其他使用串口的设备；
        ...
        /// <summary>
        ///   Looks up a localized string similar to 从excel读取信道信息.
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to 导出信道到excel.
        /// </summary>
