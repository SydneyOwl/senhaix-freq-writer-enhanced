...
public class ContextDropBehaviorFix:Behavior<Control>
{
    ...
    public static readonly StyledProperty<object?> ContextProperty = AvaloniaProperty.Register<ContextDropBehavior, object>(nameof (Context));
    public static readonly StyledProperty<IDropHandler?> HandlerProperty = AvaloniaProperty.Register<ContextDropBehavior, IDropHandler>(nameof (Handler));
    ...
    private void DragLeave(object? sender, RoutedEventArgs e) => Handler?.Leave(sender, e);
